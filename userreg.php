...
if(isset($_POST['submit'])){
	...
	$inst="INSERT INTO userinfo(Name,Username,Email,Mobile,Address,Password) VALUES('$name','$user','$email','$mobile','$address','$pass')"; 
	$data=mysqli_query($cont,$inst);
	if($data == TRUE)
            {
                echo "<script>alert('Data updated successfully..!');window.location='Userlogin.php';</script>";   
            }
